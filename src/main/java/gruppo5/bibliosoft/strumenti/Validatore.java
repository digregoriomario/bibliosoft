...
public class Validatore {
     ...
     * @pre "autori": Verifica che i nomi contengano solo lettere, spazi o
     * punti.
     *
     * @throws IllegalArgumentException Se uno qualsiasi dei dati non rispetta
     * le precondizioni.
     ...
     *
     * @throws IllegalArgumentException Se i dati non rispettano il
     * formato richiesto delle precondizioni.
     * @throws NullPointerException Se l'oggetto libro è null.
     */
